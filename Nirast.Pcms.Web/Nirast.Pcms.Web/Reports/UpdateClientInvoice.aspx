<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UpdateClientInvoice.aspx.cs" Inherits="Nirast.Pcms.Web.Reports.UpdateClientInvoice" %>
...
<body  onload="hideProgress();">
    ...
    <form id="form1" runat="server" >
       ...
       <asp:Button ID="Button2" runat="server" Text="Generate Invoice"  OnClientClick="showProgress()" class="btn btn-primary " OnClick="Button2_Click" />
            </div>
...
&nbsp;<span class="col-md-12 no-padding labelStyle info" title="">Report will be sent to the above Email ID</span>
                ...
                <span id="result"></span>
                <asp:Button ID="btnSend" runat="server" Text="Send" 	OnClick="Btnsend_Click" OnClientClick="showProgress()" class="btn btn-primary " style="height: 34px" />
               </div>
                            ...
                            <div id="dvMain" name="dvMain">
                                ...
                                <div class="col-md-12">
                                    <div class="signature-pad col-md-12">
                                        ...
                                        <div class="panel panel-group panel-success">
                                            <div class="panel-heading"><h5>Seperate Invoice</h5></div>
                                            <div class="panel-body" >
