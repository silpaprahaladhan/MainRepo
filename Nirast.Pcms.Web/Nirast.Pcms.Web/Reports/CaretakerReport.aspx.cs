...
{
    public partial class CaretakerReport : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                try
                {
                    ...
                    ReportViewer1.LocalReport.DisplayName = "CaretakerSchedulingReport";
                    ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/Reports/CaretakerAvailablity.rdlc");
