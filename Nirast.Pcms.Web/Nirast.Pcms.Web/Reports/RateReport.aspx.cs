...
{
    public partial class RateReport : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                try
                {
                    ...
                    ReportViewer1.LocalReport.DisplayName = "Commission Report";
                    ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/Reports/Rate.rdlc");
                    ...
                    searchInputs.branch = branch;

                    string api = "CareTaker/GetCommissionListReport";
